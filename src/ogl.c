...
VALUE obj,arg1,arg2,arg3,arg4;
{
    ...
    format = (GLint)NUM2INT(arg3);
    type = (GLint)NUM2INT(arg4);
    size_t format_size = glformat_size(format);
    size_t type_size = gltype_size(type) / 8;
    if (format != -1 && type != -1)
    {
        GLint width, height;
        glGetTexLevelParameteriv(target, level, GL_TEXTURE_WIDTH, &width);
        glGetTexLevelParameteriv(target, level, GL_TEXTURE_HEIGHT, &height);
        pixels = allocate_buffer_with_string(width*height*
                                             format_size*type_size);
        glGetTexImage(target, level, format, type, RSTRING_PTR(pixels));
        return pixels;
    }
    return Qnil;
}
...
static VALUE
gl_BindProgramARB(obj,arg1,arg2)
VALUE obj,arg1,arg2;
{
    GLenum target;
    GLuint program;
    target = (GLenum)NUM2INT(arg1);
    program = (GLuint)NUM2INT(arg2);
    glBindProgramARB(target,program);
    return Qnil;
}

static VALUE
gl_DeleteProgramsARB(obj,arg1)
VALUE obj,arg1;
{
    GLsizei n;
    GLuint *programs;
    ...
    n = ary->len;
    programs = xmalloc(n);
    ary2cint((VALUE)ary,(int*)programs,0); /* OK?
...
VALUE obj,arg1;
{
    ...
    if (!programs)
	rb_raise(rb_eRuntimeError, "GL.GenProgramsARB mamory allocation");
...
static VALUE
gl_IsProgramARB(obj,arg1)
VALUE obj,arg1;
{
    GLuint program;
    GLboolean ret;
    program = (GLuint)NUM2INT(arg1);
    ret = glIsTexture(program);
    return INT2NUM(ret);
}

static VALUE
gl_ProgramLocalParameter4fARB(obj,arg1,arg2,arg3,arg4,arg5,arg6)
VALUE obj,arg1,arg2,arg3,arg4,arg5,arg6;
{
    GLenum target;
    GLuint index;
    GLfloat x,y,z,w;
    target = (GLenum)NUM2INT(arg1);
    index = (GLuint)NUM2INT(arg2);
    x = (GLfloat)NUM2DBL(arg3);
    y = (GLfloat)NUM2DBL(arg4);
    z = (GLfloat)NUM2DBL(arg5);
    w = (GLfloat)NUM2DBL(arg6);
    glProgramLocalParameter4fARB(target,index,x,y,z,w);
    return Qnil;
}

static VALUE
gl_ProgramStringARB(obj,arg1,arg2,arg3,arg4)
VALUE obj,arg1,arg2,arg3,arg4;
{
    GLenum target;
    GLenum format;
    ...
    len = (GLsizei)NUM2INT(arg3);
    string = STR2CSTR(arg4);
...
static VALUE
gl_ActiveTextureARB(obj,arg1)
VALUE obj,arg1;
{
    GLenum unit;
    unit = (GLenum)NUM2INT(arg1);
    glActiveTextureARB(unit);
    return Qnil;
}

static VALUE
gl_ClientActiveTextureARB(obj,arg1)
VALUE obj,arg1;
{
    GLenum unit;
    unit = (GLenum)NUM2INT(arg1);
...
InitializeGL()
{
    ...
    rb_define_module_function(mOGL, "GetTexImage", gl_GetTexImage, 4);
    ...
    rb_define_module_function(mOGL, "TexEnv", gl_TexEnv, 3);
...
/*#if defined (GL_ARB_vertex_program) && GL_ARB_vertex_program
    rb_define_module_function(mOGL, "BindProgramARB", gl_BindProgramARB, 2);
    rb_define_module_function(mOGL, "DeleteProgramsARB", gl_DeleteProgramsARB, 2);
    rb_define_module_function(mOGL, "GenProgramsARB", gl_GenProgramsARB, 1);
    rb_define_module_function(mOGL, "IsProgramARB", gl_IsProgramARB, 1);
    rb_define_module_function(mOGL, "ProgramLocalParameter4fARB", gl_ProgramLocalParameter4fARB, 6);
    rb_define_module_function(mOGL, "ProgramStringARB", gl_ProgramStringARB, 4);
#endif

#if defined (GL_ARB_multitexture) && GL_ARB_multitexture
    rb_define_module_function(mOGL, "ActiveTextureARB", gl_ActiveTextureARB, 1);
    rb_define_module_function(mOGL, "ClientActiveTextureARB", gl_ClientActiveTextureARB, 1);
#endif*/
...
/*#if defined(GL_VERSION_1_2)
	...
	rb_define_const(mOGL, "TEXTURE_RECTANGLE_EXT", INT2NUM(GL_TEXTURE_RECTANGLE_EXT));
...
#define GL_ALL_CLIENT_ATTRIB_BITS GL_CLIENT_ALL_ATTRIB_BITS
    ...
    rb_define_const(mOGL, "MULTISAMPLE", INT2NUM(GL_MULTISAMPLE));
#endif

#if defined(GL_VERSION_1_3)
    rb_define_const(mOGL, "COMBINE", INT2NUM(GL_COMBINE));
    rb_define_const(mOGL, "COMBINE_RGB", INT2NUM(GL_COMBINE_RGB));
    rb_define_const(mOGL, "COMBINE_ALPHA", INT2NUM(GL_COMBINE_ALPHA));
    rb_define_const(mOGL, "RGB_SCALE", INT2NUM(GL_RGB_SCALE));
    rb_define_const(mOGL, "ADD_SIGNED", INT2NUM(GL_ADD_SIGNED));
    rb_define_const(mOGL, "INTERPOLATE", INT2NUM(GL_INTERPOLATE));
    rb_define_const(mOGL, "CONSTANT", INT2NUM(GL_CONSTANT));
    rb_define_const(mOGL, "PRIMARY_COLOR", INT2NUM(GL_PRIMARY_COLOR));
    rb_define_const(mOGL, "PREVIOUS", INT2NUM(GL_PREVIOUS));
    rb_define_const(mOGL, "SUBTRACT", INT2NUM(GL_SUBTRACT));
    rb_define_const(mOGL, "SOURCE0_RGB", INT2NUM(GL_SOURCE0_RGB));
    rb_define_const(mOGL, "SOURCE1_RGB", INT2NUM(GL_SOURCE1_RGB));
    rb_define_const(mOGL, "SOURCE2_RGB", INT2NUM(GL_SOURCE2_RGB));
    rb_define_const(mOGL, "SOURCE0_ALPHA", INT2NUM(GL_SOURCE0_ALPHA));
    rb_define_const(mOGL, "SOURCE1_ALPHA", INT2NUM(GL_SOURCE1_ALPHA));
    rb_define_const(mOGL, "SOURCE2_ALPHA", INT2NUM(GL_SOURCE2_ALPHA));
    rb_define_const(mOGL, "OPERAND0_RGB", INT2NUM(GL_OPERAND0_RGB));
    rb_define_const(mOGL, "OPERAND1_RGB", INT2NUM(GL_OPERAND1_RGB));
    rb_define_const(mOGL, "OPERAND2_RGB", INT2NUM(GL_OPERAND2_RGB));
    rb_define_const(mOGL, "OPERAND0_ALPHA", INT2NUM(GL_OPERAND0_ALPHA));
    rb_define_const(mOGL, "OPERAND1_ALPHA", INT2NUM(GL_OPERAND1_ALPHA));
    rb_define_const(mOGL, "OPERAND2_ALPHA", INT2NUM(GL_OPERAND2_ALPHA));
#endif

#if defined(GL_SGIS_generate_mipmap) && GL_SGIS_generate_mipmap
    rb_define_const(mOGL, "GENERATE_MIPMAP_SGIS", INT2NUM(GL_GENERATE_MIPMAP_SGIS));
#endif
#if defined(GL_SGIS_texture_edge_clamp) && GL_SGIS_texture_edge_clamp
    rb_define_const(mOGL, "CLAMP_TO_EDGE_SGIS", INT2NUM(GL_CLAMP_TO_EDGE_SGIS));
#endif
/* Incompatible with Windows
/*#if defined (GL_ARB_vertex_program) && GL_ARB_vertex_program
    rb_define_const(mOGL, "VERTEX_PROGRAM_ARB", INT2NUM(GL_VERTEX_PROGRAM_ARB));
    rb_define_const(mOGL, "PROGRAM_ERROR_POSITION_ARB", INT2NUM(GL_PROGRAM_ERROR_POSITION_ARB));
    rb_define_const(mOGL, "PROGRAM_ERROR_STRING_ARB", INT2NUM(GL_PROGRAM_ERROR_STRING_ARB));
    rb_define_const(mOGL, "PROGRAM_FORMAT_ASCII_ARB", INT2NUM(GL_PROGRAM_FORMAT_ASCII_ARB));
#endif
#if defined (GL_ARB_multitexture) && GL_ARB_multitexture
    rb_define_const(mOGL, "TEXTURE0_ARB", INT2NUM(GL_TEXTURE0_ARB));
    rb_define_const(mOGL, "TEXTURE1_ARB", INT2NUM(GL_TEXTURE1_ARB));
    rb_define_const(mOGL, "TEXTURE2_ARB", INT2NUM(GL_TEXTURE2_ARB));
    rb_define_const(mOGL, "TEXTURE3_ARB", INT2NUM(GL_TEXTURE3_ARB));
    rb_define_const(mOGL, "TEXTURE4_ARB", INT2NUM(GL_TEXTURE4_ARB));
    rb_define_const(mOGL, "TEXTURE5_ARB", INT2NUM(GL_TEXTURE5_ARB));
    rb_define_const(mOGL, "TEXTURE6_ARB", INT2NUM(GL_TEXTURE6_ARB));
    rb_define_const(mOGL, "TEXTURE7_ARB", INT2NUM(GL_TEXTURE7_ARB));
#endif*/
